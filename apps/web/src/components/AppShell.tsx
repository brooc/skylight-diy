  ...
  return (
    <div className="min-h-screen bg-[#f7f7f5] px-2 py-2 text-slate-900 md:px-3 md:py-3">
      <div className="mx-auto flex w-full max-w-[1480px] gap-2 md:gap-3">
        <aside className="sticky top-3 hidden h-[calc(100dvh-1.5rem)] w-[92px] shrink-0 overflow-hidden rounded-md border border-[#dde5ef] bg-[#eef3fa] md:flex md:flex-col md:items-center">
          ...
          <nav className="flex min-h-0 w-full flex-1 flex-col gap-1 px-1 py-1">
            {links.map((link) => {
              return (
                <NavLink
                  key={link.to}
