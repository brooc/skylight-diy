...
export function ChoresPage(): JSX.Element {
  ...
  return (
    <div className="grid gap-4 pb-20">
      ...
      <button type="button" aria-label="Add" className="fixed bottom-6 right-6 z-30 flex h-14 w-14 items-center justify-center rounded-full bg-[#2b98db] text-4xl text-white shadow-lg" onClick={() => { setSubmitError(null); setIsAdding(true); }}>+</button>
    </div>
  );
}
