...
export function CalendarEventCreateDialog({
                ...
                : {
                    ...
                    days:
                      repeat === "weekly"
                        ? weekdays
                            .filter((weekday) =>
                              weeklyDays.includes(weekday.code),
                            )
  ...
  const organizerEmail = selectedDestination
    ? /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(selectedDestination.externalCalendarId)
            ...
            {loading ? (
              ...
              <div className="grid gap-3 rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-950">
                <p>
                  ...
                  authorize the Google account and explicitly allow writes for
                  the calendars family members may use.
                </p>
                <Link
                  to="/settings"
              ...
              <>
                ...
                <label className="grid min-w-0 gap-1">
                    ...
                    onChange={(event) =>
                      setReminderMinutesBefore(event.target.value)
                    }
                  ...
                  >
                    ...
                    <span className="text-xs text-slate-500">
                      Saved to Google Calendar. Daymark will show it and read the event aloud.
                    </span>
                </label>
